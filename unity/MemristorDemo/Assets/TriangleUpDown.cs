...
/** @author timmolter */
public class TriangleUpDown : WaveformDriver
{
   ...
   * @param frequency
   */
  public TriangleUpDown(string name, double dcOffset, double phase, double amplitude, double frequency) : base(name, dcOffset, phase, amplitude, frequency)
    {
    }
