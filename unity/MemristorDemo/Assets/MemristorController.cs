...
public class MemristorController
{
    ...
    public static int PULSE_WIDTH_IN_NANO_SECONDS = 50_000; //is this micro or nanoseconds?
    ...
    public static void CheckerboardExperiment() {
        ...
        // form device
        reads = PulseUtility.TestMeminline(Waveform.HalfSine, -V_WRITE, -V_RESET, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS);
    ...
    public static void EraseWriteReadTestExperiment()
    {
        ...
        // form device        
        PulseUtility.EraseWriteReadTestExperiment(Waveform.Square, Waveform.HalfSine, -V_WRITE, -V_RESET, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS);
    ...
    public static void ReadTestAfterDisconnectExperiment()
    {
        ...
        // form device        
        PulseUtility.ReadAfterDisconnectExperiment(Waveform.Square, Waveform.HalfSine, -V_WRITE, -V_RESET, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS);
    ...
    public static void DCExperiment()
    {
        ...
        PulseUtility.measureAllSwitchResistances(Waveform.HalfSine, -V_RESET, PULSE_WIDTH_IN_NANO_SECONDS);
        Thread.Sleep(25);
        var clear1Data = PulseUtility.measureAllSwitchResistances(Waveform.Square, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS);
        Logger.dataQueue.Add(FormatResistanceArray("ERASE       ", clear1Data));
        Thread.Sleep(25);
        PulseUtility.measureAllSwitchResistances(Waveform.HalfSine, -V_RESET, PULSE_WIDTH_IN_NANO_SECONDS);
        Thread.Sleep(25);
        var clear2Data = PulseUtility.measureAllSwitchResistances(Waveform.Square, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS);
        ...
        for (int i = 0; i < 16; i++)
        {
            ...
            PulseUtility.DCExperiment(i, Waveform.Square, Waveform.HalfSine, -V_WRITE, -V_RESET, -V_READ, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS, PULSE_WIDTH_IN_NANO_SECONDS);
    ...
    public static void OneTritADCExperiment()
    {
        ...
        PulseUtility.EraseSingleMemristor(0, Waveform.HalfSine, -V_RESET, PULSE_WIDTH_IN_NANO_SECONDS);
