...
/** @author timmolter */
    public class Square : WaveformDriver
    {
         ...
         * @param frequency
         */
        public Square(string name, double dcOffset, double phase, double amplitude, double frequency) : base(name, dcOffset, phase, amplitude, frequency)
        {
        }
