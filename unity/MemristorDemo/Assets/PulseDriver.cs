...
public abstract class PulseDriver : Driver
{
    protected double pulseWidth;
    protected double dutyCycle;

    public PulseDriver(string id, double dcOffset, double pulseWidthInNS, double dutyCycle, double amplitude) : base(id, dcOffset, amplitude, 1 / (pulseWidthInNS * 1E-9 / dutyCycle))
    {
