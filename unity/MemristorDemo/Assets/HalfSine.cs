...
using System;
    ...
    /** @author timmolter */
    public class HalfSine : WaveformDriver
    {
         ...
         * @param frequency
         */
        public HalfSine(string name, double dcOffset, double phase, double amplitude, double frequency) : base(name, dcOffset, phase, amplitude, frequency)
        {
        }
