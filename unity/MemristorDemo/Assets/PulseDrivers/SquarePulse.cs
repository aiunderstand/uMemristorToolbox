...
public class SquarePulse : PulseDriver
{
  public SquarePulse(string id, double dcOffset, double pulseWidth, double dutyCycle, double amplitude) : base(id, dcOffset, pulseWidth, dutyCycle, amplitude)
{
}
