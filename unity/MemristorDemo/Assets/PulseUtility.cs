...
public class PulseUtility
{
    ...
    public static void  ReadSingle2(int id, int groundTruth)
    {
        ...
        var resistance = getSwitchResistancekOhm(Waveform.Square, (float) -Model.GetAmplitude(), MemristorController.PULSE_WIDTH_IN_NANO_SECONDS, (int)CHANNELS.CHANNEL_1);
    ...
    public static void SingleWrite2(int id, PulseType type, float voltage)
    {
        ...
        getSwitchResistancekOhm(Model.GetWaveform(), (float)-Model.GetAmplitude(), MemristorController.PULSE_WIDTH_IN_NANO_SECONDS, (int)CHANNELS.CHANNEL_1);
    }
    ...
    public static void WriteSingle(int id, int state)
    {
        ...
        while (stateReached == false)
        {
                ...
                case 1:
                {
                    ...
                    if (tries == 0)
                    {
                        ...
                        getSwitchResistancekOhm(Waveform.HalfSine, -MemristorController.V_RESET,
                            MemristorController.PULSE_WIDTH_IN_NANO_SECONDS, (int) CHANNELS.CHANNEL_1);
                        Thread.Sleep(25);
                    }
            ...
            //do read pulse
            var resistance = getSwitchResistancekOhm(Waveform.Square, -MemristorController.V_READ, MemristorController.PULSE_WIDTH_IN_NANO_SECONDS, (int)CHANNELS.CHANNEL_1);
